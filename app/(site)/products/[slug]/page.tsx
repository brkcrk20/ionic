      ...
      >
        ...
        <div className="w-full max-w-5xl mx-auto relative z-10 mt-8 pl-0 lg:pl-12">
          <div className="max-w-3xl flex flex-col items-start gap-6">
            ...
            <a
              href="#katalog"
              className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md border-2 border-[#B87332] hover:bg-[#B87332]/20 text-white font-bold text-sm tracking-wider uppercase py-3.5 px-7 rounded-xl transition-all shadow-xl"
            >
