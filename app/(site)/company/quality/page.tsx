...
const FALLBACK_TR = "Kalite Politikamız";
const FALLBACK_EN = "Quality";

export async function generateMetadata(): Promise<Metadata> {
  const [page, settings] = await Promise.all([getPageByKey("quality"), getSettings()]);
...
export default async function Page() {
  const page = await getPageByKey("quality");
