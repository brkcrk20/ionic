...
const FALLBACK_TR = "Mühendislik & Üretim";
const FALLBACK_EN = "Engineering & Manufacturing";

export async function generateMetadata(): Promise<Metadata> {
  const [page, settings] = await Promise.all([getPageByKey("engineering-production"), getSettings()]);
...
export default async function Page() {
  const page = await getPageByKey("engineering-production");
