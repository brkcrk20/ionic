...
const STATIC_ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/company/about-us", priority: 0.5, changeFrequency: "monthly" },
  { path: "/company/capabilities", priority: 0.5, changeFrequency: "monthly" },
  { path: "/company/engineering-production", priority: 0.5, changeFrequency: "monthly" },
  { path: "/company/quality", priority: 0.5, changeFrequency: "monthly" },
